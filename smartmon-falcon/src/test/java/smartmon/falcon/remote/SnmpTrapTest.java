...
public class SnmpTrapTest {
  ...
  public static void main(String[] args) {
    ...
    SnmpTrapTest poc = new SnmpTrapTest();
  ...
  public void init() throws IOException {
    //目标主机的ip地址 和 端口号
    targetAddress = GenericAddress.parse("udp:192.168.6.150/162");
  ...
  public ResponseEvent sendV1Trap() throws IOException {
    ...
    v.setOid(new OID(new int[] { 1,3,6,1,4,1,48183,1,0 }));
  ...
  public ResponseEvent sendV2cTrap() throws IOException {
    ...
    pdu.addOID(new VariableBinding(new OID(new int[] { 1,3,6,1,4,1,48183,1})));
    pdu.add(v);
