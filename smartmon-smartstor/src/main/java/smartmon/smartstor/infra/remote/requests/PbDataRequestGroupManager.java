...
public interface PbDataRequestGroupManager {
  ...
  PbDataGroupResponse getGroupInfoByName(@Param("initgroup_name") String groupName);

  @RequestLine("GET /instances/initgroups/id/{initgroup_id}")
  @Headers({"Content-Type: application/json"})
  PbDataGroupResponse getGroupInfoById(@Param("initgroup_id") String groupId);
  ...
  @Headers({"Content-Type: application/json"})
  PbDataGroupResponse groupAdd(@RequestBody PbDataGroupAddParam groupAddParam);
