...
touch "${SMARTMON_LOG_DIR}/smartmon-gateway-start.log"
date 2>&1 > ${SMARTMON_LOG_DIR}/smartmon-gateway-start.log
echo "$JAVA ${JAVA_OPT}" >> ${SMARTMON_LOG_DIR}/smartmon-gateway-start.log 2>&1 &
